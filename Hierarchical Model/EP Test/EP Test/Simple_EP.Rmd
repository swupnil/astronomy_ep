...
\pagebreak
\section{5. Inverse Logistic Model}
\subsection{Formulation}
...
$$ \theta_p = \phi_p \hspace{30 pt} \tau_p = e^{\phi_{p+5}}$$
$$ \log a_{pj} \sim N(\theta_p, \tau_p)$$
$$ x_{ij} \sim U(0,50)$$
$$ \epsilon_{ij} \sim N(0, 1)$$
$$ y_{ij} = a_{1j} + \text{logit}^{-1} \biggl(\frac{x_{ij} - a_{2j}}{a_{3j}}\biggr) \cdot a_{4j} + a_{5j} \epsilon_{ij} $$

Generating 50 groups of $a_{pj}$'s from $\phi_{1:5} = \{ 5.89, 2.30, 0.69, 6.48, 2\}$ and $\phi_{6:10} = \{-1.07, -0.69, -0.69, -0.60, 0.0001\}$, we then sampled 500 data points from each group $j$.
...
Parameter & True & Prior & HMC & EP K=5 & EP K=10 & EP K=25 \\ [0.5ex] % inserts table %heading
\hline \\
$E(\phi_1)$ & 5.63 & 5.89 & 6.05 & 5.67 & 5.73 & 5.53 \\
$SD(\phi_1)$ & -- & 0.71 & 0.13 & 0.102 & 0.118 & 0.122 \\ \hline
$E(\phi_2)$ & 2.59 & 2.30 & 1.50 & 1.20 & 1.19 & 1.20 \\
$SD(\phi_2)$ & -- & 0.71 & 0.17 & 0.123 & 0.121 & 0.098 \\ \hline
$E(\phi_3)$ & 0.48 & 0.69 & 0.69 & 0.74 & 0.96 & 0.98 \\
$SD(\phi_3)$ & -- & 0.71 & 0.18 & 0.097 & 0.105 & 0.095 \\ \hline
$E(\phi_4)$ & 6.32 & 6.48 & 7.37 & 6.81 & 6.65 & 6.75 \\
$SD(\phi_4)$ & -- & 0.71 & 0.18 & 0.105 & 0.108 & 0.095 \\ \hline
$E(\phi_5)$ & 2.46 & 2.08 & 0.72 & 1.44 & 1.44 & 1.57 \\
